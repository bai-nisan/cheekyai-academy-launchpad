...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden scroll-smooth">
      ...
      <div className="fixed inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23ffffff" fill-opacity="0.1"%3E%3Ccircle cx="30" cy="30" r="1"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] pointer-events-none" />
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#program" className="hover:text-blue-400 transition-colors duration-200">Program</a>
              <a href="#stages" className="hover:text-blue-400 transition-colors duration-200">Stages</a>
              ...
              <Button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:scale-105 transition-transform duration-200">
                Book Discovery Call
              </Button>
            </div>
          ...
          {isMenuOpen && (
            ...
            >
              <div className="flex flex-col space-y-4">
                ...
                <a href="#stages" className="hover:text-blue-400 transition-colors">Stages</a>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:scale-105 transition-transform duration-200 text-lg px-8 py-4"
      ...
      <section id="program" className="py-32">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <Card className="bg-white/5 backdrop-blur-md border border-white/10 p-8 mb-8">
                ...
                >
                  ...
                  <Card className={`h-full p-8 ${plan.popular ? 'bg-gradient-to-br from-blue-500/10 to-purple-500/10 border-blue-500/30' : 'bg-white/5 border-white/10'} backdrop-blur-md border hover:shadow-2xl transition-all duration-300`}>
                    <CardContent className="p-0">
                      ...
                      <Button className={`w-full ${plan.popular ? 'bg-gradient-to-r from-blue-600 to-purple-600' : 'bg-white/10 hover:bg-white/20'} hover:scale-105 transition-transform duration-200`}>
                        Get Started
                      </Button>
                    </CardContent>
                  </Card>
          ...
          >
            ...
            <div className="space-y-8">
              {[
                ...
                >
                  <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center font-bold text-white">
                    {item.step}
                  </div>
                  <div>
